...
<# Install Chocolatey --------------------------------------------------------#>
function Windows_Install_Chocolatey() {
...
<# Install Fonts -------------------------------------------------------------#>
function Windows_Install_Fonts() {
	Write-Host -NoNewline " ==> Install "
...
function Windows_Install_JRE() {
	Write-Host -NoNewline " ==> Install "
	Write-Host -ForegroundColor Yellow "JRE"
	If (Get-Command java -errorAction SilentlyContinue) {
		Write-Host -NoNewline "  => Upgrade "
		Write-Host -ForegroundColor DarkYellow "JRE "
